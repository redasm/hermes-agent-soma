...
$RepoUrlSsh = "git@github.com:redasm/hermes-agent-soma.git"
$RepoUrlHttps = "https://github.com/redasm/hermes-agent-soma.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/redasm/hermes-agent-soma/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/redasm/hermes-agent-soma/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/redasm/hermes-agent-soma/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
